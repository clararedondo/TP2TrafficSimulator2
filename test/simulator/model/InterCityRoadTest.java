...
class InterCityRoadTest {
	...
	void test_1() {
		...
		//error: list incorrectly ordered, we tried to make a comparator to ensure an order but failed to make it work
	...
	void test_report() {
		...
		//error: not able to match our result of the report method to the desired String s.
	}
